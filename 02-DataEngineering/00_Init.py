...
# MAGIC %sql
# MAGIC -- CREATE CATALOG IF NOT EXISTS attij_lakehouse MANAGED LOCATION 'abfss://unity-catalog-storage@dbstoragexyfbclfd2i7hu.dfs.core.windows.net/744986589015891';
# MAGIC
# MAGIC DROP DATABASE IF EXISTS jeromeattinger_lakehouse.bronze CASCADE;
# MAGIC DROP DATABASE IF EXISTS jeromeattinger_lakehouse.silver CASCADE; 
# MAGIC DROP DATABASE IF EXISTS jeromeattinger_lakehouse.gold CASCADE;
...
# MAGIC CREATE DATABASE IF NOT EXISTS jeromeattinger_lakehouse.silver;
# MAGIC CREATE DATABASE IF NOT EXISTS jeromeattinger_lakehouse.gold;
# MAGIC
