...
# MAGIC
# MAGIC
# MAGIC MERGE INTO silver.customeraddress AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         CustomerID    AS customer_id,
# MAGIC         AddressID     AS address_id,
# MAGIC         AddressType   AS address_type,
# MAGIC         rowguid       AS rowguid,
# MAGIC         ModifiedDate  AS modified_date
# MAGIC     FROM bronze.customeraddress
# MAGIC ) AS src
# MAGIC ON tgt.customer_id = src.customer_id
# MAGIC    AND tgt.address_id = src.address_id
# MAGIC    AND tgt._tf_valid_to IS NULL   -- Only match against 'active' records in silver
# MAGIC
# MAGIC WHEN MATCHED AND (
# MAGIC        tgt.address_type    != src.address_type
# MAGIC     OR tgt.rowguid         != src.rowguid
# MAGIC     OR tgt.modified_date   != src.modified_date
# MAGIC     -- etc. for any columns you want to track changes on
# MAGIC ) AND tgt._tf_valid_to IS NULL THEN
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new customeraddress or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     customer_id,
# MAGIC     address_id,
# MAGIC     address_type,
...
# MAGIC     color STRING,
# MAGIC     standard_cost DECIMAL,
# MAGIC     list_price DECIMAL,
# MAGIC     size STRING,
...
# MAGIC );
# MAGIC
# MAGIC MERGE INTO silver.product AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         ProductID           AS product_id,
# MAGIC         Name                AS name,
# MAGIC         ProductNumber       AS product_number,
# MAGIC         Color               AS color,
# MAGIC         StandardCost        AS standard_cost,
# MAGIC         ListPrice           AS list_price,
# MAGIC         Size                AS size,
# MAGIC         Weight              AS weight,
# MAGIC         ProductCategoryID   AS product_category_id,
# MAGIC         ProductModelID      AS product_model_id,
# MAGIC         SellStartDate       AS sell_start_date,
# MAGIC         SellEndDate         AS sell_end_date,
# MAGIC         DiscontinuedDate    AS discontinued_date,
# MAGIC         ThumbNailPhoto      AS thumbnail_photo,
# MAGIC         ThumbnailPhotoFileName AS thumbnail_photo_file_name,
# MAGIC         rowguid             AS rowguid,
# MAGIC         ModifiedDate        AS modified_date
# MAGIC     FROM bronze.product
# MAGIC ) AS src
...
# MAGIC     OR tgt.product_number        != src.product_number
# MAGIC     OR tgt.color                 != src.color
# MAGIC     OR tgt.standard_cost         != src.standard_cost
# MAGIC     OR tgt.list_price            != src.list_price
# MAGIC     OR tgt.size                  != src.size
# MAGIC     OR tgt.weight                != src.weight
# MAGIC     OR tgt.product_category_id   != src.product_category_id
# MAGIC     OR tgt.product_model_id      != src.product_model_id
# MAGIC     OR tgt.sell_start_date       != src.sell_start_date
# MAGIC     OR tgt.sell_end_date         != src.sell_end_date
# MAGIC     OR tgt.discontinued_date     != src.discontinued_date
# MAGIC     OR tgt.thumbnail_photo       != src.thumbnail_photo
# MAGIC     OR tgt.thumbnail_photo_file_name != src.thumbnail_photo_file_name
# MAGIC     OR tgt.rowguid               != src.rowguid
# MAGIC     OR tgt.modified_date         != src.modified_date
# MAGIC ) AND tgt._tf_valid_to IS NULL THEN
# MAGIC   -- 1) Close the old record by setting _tf_valid_to
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new product or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     product_id,
# MAGIC     name,
...
# MAGIC     size,
# MAGIC     weight,
# MAGIC     product_category_id,
# MAGIC     product_model_id,
# MAGIC     sell_start_date,
# MAGIC     sell_end_date,
# MAGIC     discontinued_date,
# MAGIC     thumbnail_photo,
# MAGIC     thumbnail_photo_file_name,
# MAGIC     rowguid,
# MAGIC     modified_date,
# MAGIC     _tf_valid_from,
# MAGIC     _tf_valid_to,
...
# MAGIC     src.product_id,
# MAGIC     src.name,
# MAGIC     src.product_number,
# MAGIC     src.color,
# MAGIC     src.standard_cost,
# MAGIC     src.list_price,
# MAGIC     src.size,
# MAGIC     src.weight,
# MAGIC     src.product_category_id,
# MAGIC     src.product_model_id,
# MAGIC     src.sell_start_date,
# MAGIC     src.sell_end_date,
# MAGIC     src.discontinued_date,
# MAGIC     src.thumbnail_photo,
# MAGIC     src.thumbnail_photo_file_name,
# MAGIC     src.rowguid,
# MAGIC     src.modified_date,
# MAGIC     load_date,        -- _tf_valid_from
# MAGIC     NULL,             -- _tf_valid_to
...
# MAGIC );
# MAGIC
# MAGIC MERGE INTO silver.productcategory AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         ProductCategoryID       AS product_category_id,
# MAGIC         ParentProductCategoryID AS parent_product_category_id,
# MAGIC         Name                    AS name,
# MAGIC         rowguid                 AS rowguid,
# MAGIC         ModifiedDate            AS modified_date
# MAGIC     FROM bronze.productcategory
# MAGIC ) AS src
# MAGIC ON tgt.product_category_id = src.product_category_id
# MAGIC    AND tgt._tf_valid_to IS NULL   -- Only match against 'active' records in silver
# MAGIC
# MAGIC WHEN MATCHED AND (
# MAGIC        tgt.parent_product_category_id != src.parent_product_category_id
# MAGIC     OR tgt.name                          != src.name
# MAGIC     OR tgt.rowguid                       != src.rowguid
# MAGIC     OR tgt.modified_date                 != src.modified_date
# MAGIC ) AND tgt._tf_valid_to IS NULL THEN
# MAGIC   -- 1) Close the old record by setting _tf_valid_to
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new productcategory or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     product_category_id,
# MAGIC     parent_product_category_id,
# MAGIC     name,
# MAGIC     rowguid,
# MAGIC     modified_date,
# MAGIC     _tf_valid_from,
...
# MAGIC   VALUES (
# MAGIC     src.product_category_id,
# MAGIC     src.parent_product_category_id,
# MAGIC     src.name,
# MAGIC     src.rowguid,
# MAGIC     src.modified_date,
# MAGIC     load_date,        -- _tf_valid_from
...
# MAGIC );
# MAGIC
# MAGIC MERGE INTO silver.productdescription AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         ProductDescriptionID AS product_description_id,
# MAGIC         Description          AS description,
# MAGIC         rowguid              AS rowguid,
# MAGIC         ModifiedDate         AS modified_date
# MAGIC     FROM bronze.productdescription
# MAGIC ) AS src
# MAGIC ON tgt.product_description_id = src.product_description_id
# MAGIC    AND tgt._tf_valid_to IS NULL   -- Only match against 'active' records in silver
# MAGIC
# MAGIC WHEN MATCHED AND (
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new productdescription or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     product_description_id,
# MAGIC     description,
# MAGIC     rowguid,
# MAGIC     modified_date,
# MAGIC     _tf_valid_from,
...
# MAGIC   )
# MAGIC   VALUES (
# MAGIC     src.product_description_id,
...
# MAGIC );
# MAGIC
# MAGIC MERGE INTO silver.productmodel AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         ProductModelID       AS product_model_id,
# MAGIC         Name                 AS name,
# MAGIC         CatalogDescription   AS catalog_description,
# MAGIC         rowguid              AS rowguid,
# MAGIC         ModifiedDate         AS modified_date
# MAGIC     FROM bronze.productmodel
# MAGIC ) AS src
# MAGIC ON tgt.product_model_id = src.product_model_id
# MAGIC    AND tgt._tf_valid_to IS NULL   -- Only match against 'active' records in silver
# MAGIC
# MAGIC WHEN MATCHED AND (
# MAGIC        tgt.name                   != src.name
# MAGIC     OR tgt.catalog_description     != src.catalog_description
# MAGIC     OR tgt.rowguid                 != src.rowguid
# MAGIC     OR tgt.modified_date           != src.modified_date
# MAGIC ) AND tgt._tf_valid_to IS NULL THEN
# MAGIC   -- 1) Close the old record by setting _tf_valid_to
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new productmodel or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     product_model_id,
# MAGIC     name,
# MAGIC     catalog_description,
# MAGIC     rowguid,
# MAGIC     modified_date,
# MAGIC     _tf_valid_from,
# MAGIC     _tf_valid_to,
...
# MAGIC );
# MAGIC
# MAGIC MERGE INTO silver.productmodelproductdescription AS tgt
# MAGIC USING (
# MAGIC     SELECT
# MAGIC         ProductModelID       AS product_model_id,
# MAGIC         ProductDescriptionID AS product_description_id,
# MAGIC         Culture              AS culture,
# MAGIC         rowguid              AS rowguid,
# MAGIC         ModifiedDate         AS modified_date
# MAGIC     FROM bronze.productmodelproductdescription
# MAGIC ) AS src
# MAGIC ON tgt.product_model_id = src.product_model_id
# MAGIC    AND tgt.product_description_id = src.product_description_id
# MAGIC    AND tgt._tf_valid_to IS NULL   -- Only match against 'active' records in silver
# MAGIC
# MAGIC WHEN MATCHED AND (
# MAGIC        tgt.culture                != src.culture
# MAGIC     OR tgt.rowguid                != src.rowguid
# MAGIC     OR tgt.modified_date          != src.modified_date
# MAGIC ) AND tgt._tf_valid_to IS NULL THEN
# MAGIC   -- 1) Close the old record by setting _tf_valid_to
...
# MAGIC
# MAGIC WHEN NOT MATCHED THEN
# MAGIC   -- 2) Insert NEW records (either truly new productmodelproductdescription or a new version if the old one was just closed)
# MAGIC   INSERT (
# MAGIC     product_model_id,
# MAGIC     product_description_id,
# MAGIC     culture,
...
# MAGIC   );
# MAGIC
# MAGIC UPDATE silver.productmodelproductdescription
# MAGIC SET culture = TRIM(culture)
# MAGIC WHERE culture LIKE '% ' OR culture LIKE ' %';
# MAGIC
# MAGIC
